...
function VkiHesapla({navigation}) {
  ...
  const onPress = () => {
    if (Boy * Kilo > 2) {
      onChangeHesap(hesap => (
        <View style={styles.hesapFunction}>
  ...
  return (
    <SafeAreaView>
      <View style={styles.title}>
        <Text style={styles.textHesap}>
          hesap<Text style={styles.textLa}>la</Text>
        </Text>
      </View>
      <View style={styles.fullBody}>
        ...
        <Text style={styles.Comment}>
          Doğru hesaplama için Metre cinsinden giriniz
        </Text>
        ...
        />
        <Text style={styles.Comment}>
          Doğru hesaplama için Kg cinsinden giriniz
        </Text>
    ...
    <ScrollView style={styles.fullBody}>
      ...
      <View>
        ...
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate(VkiHesapla)}>
          <Text style={styles.homeNavigate}>Vücut Kitle İndeksi Hesaplama</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.ButtonNavigate}
          onPress={() => navigation.navigate(SuHesapla)}>
          <Text style={styles.homeNavigate}>
            Günlük İçilmesi Gereken Su Miktarı Hesaplama
          </Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={styles.ButtonNavigate}
          onPress={() => navigation.navigate(YaşHesapla)}>
